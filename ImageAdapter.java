...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder imageViewHolder, int i) {
        ...
        imageViewHolder.textViewplace.setText(UploadCurrent.getPlace());
        imageViewHolder.textViewtime.setText(UploadCurrent.getTime());
        imageViewHolder.textViewtype.setText(UploadCurrent.getType());
        imageViewHolder.textViewemail.setText(UploadCurrent.getEmail());
